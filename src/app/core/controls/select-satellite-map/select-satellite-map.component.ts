import {
  SettingService
} from './../../services/local/setting/setting.service';
import {
  Component,
  OnInit,
  forwardRef,
...
@Component({
  selector: 'app-select-satellite-map',
  templateUrl: './select-satellite-map.component.html',
  styleUrls: ['./select-satellite-map.component.css'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SelectSatelliteMapComponent),
    multi: true
  }]
})
export class SelectSatelliteMapComponent implements OnInit {
  ...
  private _placeHolder = '请选择卫星图'; // 输入提示
  ...
  // }
  get dataset() {
    return this.setting.data_satellites;
  }
  // placeHolder
  @Input()
  get placeHolder() {
