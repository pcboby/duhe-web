...
@Component({
  selector: 'app-select-topographic-map',
  templateUrl: './select-topographic-map.component.html',
  styleUrls: ['./select-topographic-map.component.css'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SelectTopographicMapComponent),
    multi: true
  }]
})
export class SelectTopographicMapComponent implements OnInit {
  ...
  private _placeHolder = '请选择地形图'; // 输入提示
  ...
  // }
  get dataset() {
    return this.setting.data_topographics;
  }
  // placeHolder
  @Input()
  get placeHolder() {
