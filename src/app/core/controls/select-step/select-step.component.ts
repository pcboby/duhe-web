...
import { dataSteps } from '../../modules/lookups';

@Component({
  selector: 'app-select-step',
  templateUrl: './select-step.component.html',
  styleUrls: ['./select-step.component.css'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SelectStepComponent),
    multi: true
  }]
})
export class SelectStepComponent implements OnInit {
  ...
  private _dataset = dataSteps; // 下拉可选列表，支持组件外传入
