...
@Component({
  selector: 'app-page-runningaily',
  templateUrl: './page-runningaily.component.html',
  styleUrls: ['./page-runningaily.component.css']
})
export class PageRunningailyComponent implements OnInit {
