...
import { DatabaseRainfallDetailComponent } from './components/database-rainfall-detail/database-rainfall-detail.component';
import { DatabaseRainfallEditComponent } from './components/database-rainfall-edit/database-rainfall-edit.component';
...
@Component({
  selector: 'app-database-rainfall',
  templateUrl: './database-rainfall.component.html',
  styleUrls: ['./database-rainfall.component.css']
})
export class DatabaseRainfallComponent implements OnInit {
  ...
  detail(data) {
    const modal = this.modalService.create({
      nzTitle: '详情',
      nzContent: DatabaseRainfallDetailComponent,
      nzComponentParams: {
        dataset: data
      },
      nzWidth: 720,
  ...
  add() {
    const modal = this.modalService.create({
      nzTitle: '新增',
      nzContent: DatabaseRainfallEditComponent,
      nzComponentParams: {
