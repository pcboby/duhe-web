...
@Component({
  selector: 'app-database-station-curve-tmpchart',
  templateUrl: './database-station-curve-tmpchart.component.html',
  styleUrls: ['./database-station-curve-tmpchart.component.css']
})
export class DatabaseStationCurveTmpchartComponent implements OnInit {
