...
import { PageSystemModelDetailComponent } from './components/page-system-model-detail/page-system-model-detail.component';
import { PageSystemModelEditComponent } from './components/page-system-model-edit/page-system-model-edit.component';

@Component({
  selector: 'app-page-system-model',
  templateUrl: './page-system-model.component.html',
  styleUrls: ['./page-system-model.component.css']
})
export class PageSystemModelComponent implements OnInit {
  ...
  detail(data) {
    const modal = this.modalService.create({
      nzTitle: '详情',
      nzContent: PageSystemModelDetailComponent,
      nzComponentParams: {
        dataset: data
      },
      nzWidth: 720,
  ...
  add() {
    const modal = this.modalService.create({
      nzTitle: '新增',
      nzContent: PageSystemModelEditComponent,
      nzComponentParams: {
