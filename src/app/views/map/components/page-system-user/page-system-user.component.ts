...
import { SystemUserDetailComponent } from './components/system-user-detail/system-user-detail.component';
...
@Component({
  selector: 'app-page-system-user',
  templateUrl: './page-system-user.component.html',
  styleUrls: ['./page-system-user.component.css']
})
export class PageSystemUserComponent implements OnInit {
