...
import { PageSystemRoleDetailComponent } from './components/page-system-role-detail/page-system-role-detail.component';
import { PageSystemRoleEditComponent } from './components/page-system-role-edit/page-system-role-edit.component';

@Component({
  selector: 'app-page-system-role',
  templateUrl: './page-system-role.component.html',
  styleUrls: ['./page-system-role.component.css']
})
export class PageSystemRoleComponent implements OnInit {
  ...
  detail(data) {
    const modal = this.modalService.create({
      nzTitle: '详情',
      nzContent: PageSystemRoleDetailComponent,
      nzComponentParams: {
        dataset: data
      },
      nzWidth: 720,
  ...
  add() {
    const modal = this.modalService.create({
      nzTitle: '新增',
      nzContent: PageSystemRoleEditComponent,
      nzComponentParams: {
