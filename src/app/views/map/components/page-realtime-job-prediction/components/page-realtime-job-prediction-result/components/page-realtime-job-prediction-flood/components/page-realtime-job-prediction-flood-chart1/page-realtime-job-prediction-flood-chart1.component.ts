...
@Component({
  selector: 'app-page-realtime-job-prediction-flood-chart1',
  templateUrl: './page-realtime-job-prediction-flood-chart1.component.html',
  styleUrls: ['./page-realtime-job-prediction-flood-chart1.component.css']
})
export class PageRealtimeJobPredictionFloodChart1Component implements OnInit {
