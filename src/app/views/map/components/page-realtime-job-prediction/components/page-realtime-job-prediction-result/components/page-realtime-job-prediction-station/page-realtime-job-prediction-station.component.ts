...
@Component({
  selector: 'app-page-realtime-job-prediction-station',
  templateUrl: './page-realtime-job-prediction-station.component.html',
  styleUrls: ['./page-realtime-job-prediction-station.component.css']
})
export class PageRealtimeJobPredictionStationComponent implements OnInit {
