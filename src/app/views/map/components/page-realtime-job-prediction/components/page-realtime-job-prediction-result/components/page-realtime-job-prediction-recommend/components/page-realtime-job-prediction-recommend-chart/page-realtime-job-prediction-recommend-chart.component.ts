...
@Component({
  selector: 'app-page-realtime-job-prediction-recommend-chart',
  templateUrl: './page-realtime-job-prediction-recommend-chart.component.html',
  styleUrls: ['./page-realtime-job-prediction-recommend-chart.component.css']
})
export class PageRealtimeJobPredictionRecommendChartComponent implements OnInit {
