...
import { PageSystemObjectDetailComponent } from './components/page-system-object-detail/page-system-object-detail.component';
import { PageSystemObjectEditComponent } from './components/page-system-object-edit/page-system-object-edit.component';
...
@Component({
  selector: 'app-page-system-object',
  templateUrl: './page-system-object.component.html',
  styleUrls: ['./page-system-object.component.css']
})
export class PageSystemObjectComponent implements OnInit {
  ...
  detail(data) {
    const modal = this.modalService.create({
      nzTitle: '详情',
      nzContent: PageSystemObjectDetailComponent,
      nzComponentParams: {
        dataset: data
      },
      nzWidth: 720,
  ...
  add() {
    const modal = this.modalService.create({
      nzTitle: '新增',
      nzContent: PageSystemObjectEditComponent,
      nzComponentParams: {
