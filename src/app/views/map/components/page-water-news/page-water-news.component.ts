...
@Component({
  selector: 'app-page-water-news',
  templateUrl: './page-water-news.component.html',
  styleUrls: ['./page-water-news.component.css']
})
export class PageWaterNewsComponent implements OnInit {
