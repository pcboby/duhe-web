...
@Component({
  selector: 'app-page-dispatching-schemes',
  templateUrl: './page-dispatching-schemes.component.html',
  styleUrls: ['./page-dispatching-schemes.component.css']
})
export class PageDispatchingSchemesComponent implements OnInit {
