...
@Component({
  selector: 'app-condition-rain-detail',
  templateUrl: './condition-rain-detail.component.html',
  styleUrls: ['./condition-rain-detail.component.css']
})
export class ConditionRainDetailComponent implements OnInit {
