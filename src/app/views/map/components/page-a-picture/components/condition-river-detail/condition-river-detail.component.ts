...
@Component({
  selector: 'app-condition-river-detail',
  templateUrl: './condition-river-detail.component.html',
  styleUrls: ['./condition-river-detail.component.css']
})
export class ConditionRiverDetailComponent implements OnInit {
