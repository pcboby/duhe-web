...
@Component({
  selector: 'app-page-recommended-scheduling-scheme-chart',
  templateUrl: './page-recommended-scheduling-scheme-chart.component.html',
  styleUrls: ['./page-recommended-scheduling-scheme-chart.component.css']
})
export class PageRecommendedSchedulingSchemeChartComponent implements OnInit {
