...
@Component({
  selector: 'app-page-message-news',
  templateUrl: './page-message-news.component.html',
  styleUrls: ['./page-message-news.component.css']
})
export class PageMessageNewsComponent implements OnInit {
