...
@Component({
  selector: 'app-page-simulated-results-management-chart',
  templateUrl: './page-simulated-results-management-chart.component.html',
  styleUrls: ['./page-simulated-results-management-chart.component.css']
})
export class PageSimulatedResultsManagementChartComponent implements OnInit {
